<template>
    <div>
        <allHeader :loginStatus="isLogin"></allHeader>
                ...
                <div class="index_content_right">
                    ...
                    <div class="warn_push">
                        <div class="flex warn_pushNav">
                            <span v-for="(item,index) in newsNav" :key="index" @click="changePush(index)"
                                :class="{ borderBottom:changepushNav == index}">{{item}}</span>
                        </div>
                        <ul class="newsList">
